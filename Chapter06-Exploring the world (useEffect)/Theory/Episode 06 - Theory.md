...
useEffect accepts `two arguments`, a `callback function` and a `dependency array`. The second argument is optional.Callback function runs after rendering that componenet.
