  ...
  return (
    <div className="header">
      <div className="logo-container">
        <img
          className="logo"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS7qrUdpkljtKeYLOrV353LSEAuu7oNLrZyN35_fgDgxdh1ixbspLlhKPs&s"
        ></img>
      </div>
...
//* You can also give in-line css by making variable & pass into jsx:---
const styleCart = {
  background: "#f0f0f0", //at line no.50, we add it.
};
...
const RestaurantCart = (props) => {
  ...
  return (
    <div className="res-cart" style={styleCart}>
      <div className="image">
      <img
        className="res-logo"
        alt="res-logo"
...
// we can make our cart dynamic by passing PROPS.
// props (properties), its like a passing argument to the function.
// when we pass props, react wrap all the props into a object.
// Prop ==> object

const Body = () => {
  return (
    <div className="body">
      <div className="search">Search box & button</div>
